#ifndef NE_REVERBTANK_H
#define NE_REVERBTANK_H

/*
 * Based on ReverbTank.h, a part of Mozzi. Copyright 2013 Tim Barrass.
...
public:
  ...
  */
  NE_ReverbTank(
    int16_t early_reflection1 = 50,
    int16_t early_reflection2 = 200,
    int16_t early_reflection3 = 510,
    int16_t loop1_delay=450,
    uint16_t loop2_delay=1000,
...
private:
  ...
  AudioDelay <512> aLoopDel0; // 128/16384 seconds * 340.29 m/s speed of sound = 3.5 metres
  AudioDelay <512,int> aLoopDel1;
  AudioDelay <1024,int> aLoopDel2; // 7 metres
